                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="index.html"><img src="{{asset('fontend/images/home/logo.png')}}" alt="" /></a>
                        </div>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                @if(Auth::check())
                                @if(Auth::user()->role == 1)
                                <li><a href="/admin/product"><i class="fa fa-user"></i> Admin</a></li>
                                @endif
                                <li>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('fontend/images/home/girl1.jpg')}}" class="girl img-responsive"
                                        alt="" />
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('fontend/images/home/girl2.jpg')}}" class="girl img-responsive"
                                        alt="" />
                                    <img src="{{asset('fontend/images/home/pricing.png')}}" class="pricing" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('fontend/images/home/girl3.jpg')}}" class="girl img-responsive"
                                        alt="" />
                                    <img src="{{asset('fontend/images/home/pricing.png')}}" class="pricing" alt="" />
                                </div>
                            </div>
